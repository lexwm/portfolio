        ...
        <section id="resume" className="resume">
            <div className="container">
                ...
                <div className="section-title">
                    <h2>Resume</h2>
                    <p>More than 15 years in IT industry. About 7 years as team leader. Responsible. Communicative. Extensive website development experience. Use of advanced technologies.</p>
                </div>
